...
namespace FSM_framework
{
  ...
  //-----------------------------------------------------------------------------
  const std::string & algorithm_wide::get_string(void)const
  {
    return m_class_name;
  }

  //-----------------------------------------------------------------------------
  void algorithm_wide::register_algorithm(map<string,FSM_framework_algorithm_creator_t> &p_factory)
  {
    register_framework_algorithm("algorithm_wide",create_algorithm_wide,p_factory);
  }
...
#endif
  const std::string algorithm_wide::m_class_name = "algorithm_wide";
}
//EOF
