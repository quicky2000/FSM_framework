	  ...
	  if(l_node_iter == m_situation_tree.end())
	    {
	      ...
	      if(l_current_situation->isValid() && !l_current_situation->isFinal())
		{
...
//-----------------------------------------------------------------------------
string algorithm_deep::getString(void)
{
  return "algorithm_deep";
}

//-----------------------------------------------------------------------------
void algorithm_deep::registerAlgorithm(map<string,FSM_framework_algorithm_creator> &p_factory)
{
  registerFrameworkAlgorithm("algorithm_deep",createAlgorithmDeep,p_factory);
}
